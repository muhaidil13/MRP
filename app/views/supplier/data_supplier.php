...
<div class="container mt-5">
    <div class="row-sm-4">
        <a class="btn btn-info mb-3 offset-1 " href="<?php echo BASE_URL?>/supplier/tambah">Tambah</a>
        <button class="btn btn-success mb-3 ms-2">Print</button>
    </div>
    <div class="row">
        <table class="m-auto table table-hover text-center" style="width:70vw">
            ...
            <tbody>
                <?php $i = 1;?>
                <?php foreach($data['sup'] as $data) : ?>
                <tr>
                    <th scope="row"><?php echo $i?></th>
                    <td style="display:none;"><?php echo $data['id_supplier']?></td>
                    <td><?php echo $data['nama_supplier']?></td>
                    <td><?php echo $data['owner_supplier']?></td>
