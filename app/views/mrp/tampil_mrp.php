...
<div class="container mt-5">
    <div class="row-sm-4">
        <a class="btn btn-info mb-4 " href="<?php echo BASE_URL?>/material/tambah_material">Tambah</a>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="<?php echo BASE_URL?>/material/hapus_material/<?php echo $data['material_code']?>"
